...
final class Rara_Fonts {
	...
	public static function get_standard_fonts() {        
        return apply_filters( 'rara-fonts/fonts/standard_fonts', array(
    		'georgia-serif' => array(
    			'label' => _x( 'Georgia', 'font style', 'travel-agency-pro' ),
    			'stack' => 'georgia-serif',
    		),
            'palatino-serif' => array(
    			'label' => _x( 'Palatino Linotype, Book Antiqua, Palatino', 'font style', 'travel-agency-pro' ),
    			'stack' => 'palatino-serif',
    		),
            'times-serif' => array(
    			'label' => _x( 'Times New Roman, Times', 'font style', 'travel-agency-pro' ),
    			'stack' => 'times-serif',
    		),
            'arial-helvetica' => array(
    			'label' => _x( 'Arial, Helvetica', 'font style', 'travel-agency-pro' ),
    			'stack' => 'arial-helvetica',
    		),
            'arial-gadget' => array(
    			'label' => _x( 'Arial Black, Gadget', 'font style', 'travel-agency-pro' ),
    			'stack' => 'arial-gadget',
    		),
    		'comic-cursive' => array(
    			'label' => _x( 'Comic Sans MS, cursive', 'font style', 'travel-agency-pro' ),
    			'stack' => 'comic-cursive',
    		),
    		'impact-charcoal'  => array(
    			'label' => _x( 'Impact, Charcoal', 'font style', 'travel-agency-pro' ),
    			'stack' => 'impact-charcoal',
    		),
            'lucida' => array(
    			'label' => _x( 'Lucida Sans Unicode, Lucida Grande', 'font style', 'travel-agency-pro' ),
    			'stack' => 'lucida',
    		),
            'tahoma-geneva' => array(
    			'label' => _x( 'Tahoma, Geneva', 'font style', 'travel-agency-pro' ),
    			'stack' => 'tahoma-geneva',
    		),
    		'trebuchet-helvetica' => array(
    			'label' => _x( 'Trebuchet MS, Helvetica', 'font style', 'travel-agency-pro' ),
    			'stack' => 'trebuchet-helvetica',
    		),
    		'verdana-geneva'  => array(
    			'label' => _x( 'Verdana, Geneva', 'font style', 'travel-agency-pro' ),
    			'stack' => 'verdana-geneva',
    		),
            'courier' => array(
    			'label' => _x( 'Courier New, Courier', 'font style', 'travel-agency-pro' ),
    			'stack' => 'courier',
    		),
            'lucida-monaco' => array(
    			'label' => _x( 'Lucida Console, Monaco', 'font style', 'travel-agency-pro' ),
    			'stack' => 'lucida-monaco',
    		)
    	)); 
	}
	...
	public static function get_all_variants() {
		return apply_filters( 'rara-fonts/fonts/font_variants', array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'travel-agency-pro' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'travel-agency-pro' ),
			'200'       => esc_attr__( 'Light 200', 'travel-agency-pro' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'travel-agency-pro' ),
			'300'       => esc_attr__( 'Book 300', 'travel-agency-pro' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'travel-agency-pro' ),
			'regular'   => esc_attr__( 'Normal 400', 'travel-agency-pro' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'travel-agency-pro' ),
			'500'       => esc_attr__( 'Medium 500', 'travel-agency-pro' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'travel-agency-pro' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'travel-agency-pro' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'travel-agency-pro' ),
			'700'       => esc_attr__( 'Bold 700', 'travel-agency-pro' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'travel-agency-pro' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'travel-agency-pro' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'travel-agency-pro' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'travel-agency-pro' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'travel-agency-pro' ),
		) );
	}
