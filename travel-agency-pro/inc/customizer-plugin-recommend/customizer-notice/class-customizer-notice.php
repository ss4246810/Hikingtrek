...
class Travel_Agency_Customizer_Notice {
	...
	public function scripts_for_customizer() {
		...
		wp_enqueue_style( 'travel-agency-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/css/customizer-notice.css', array(), TAP_THEME_VERSION );
		...
		wp_enqueue_script( 'travel-agency-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/js/customizer-notice.js', array( 'customize-controls' ), TAP_THEME_VERSION );
		wp_localize_script(
			'travel-agency-customizer-notice', 'customizer_notice_data', array(
				'ajaxurl'                  => admin_url( 'admin-ajax.php' ),
				'template_directory'       => get_template_directory_uri(),
				'base_path'                => admin_url(),
				'activating_string'        => __( 'Activating', 'travel-agency-pro' ),
			)
		);
