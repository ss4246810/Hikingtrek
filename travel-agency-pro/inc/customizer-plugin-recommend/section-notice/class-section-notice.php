...
class Travel_Agency_Customizer_Section {
			...
			$manager->add_section(
				new Travel_Agency_Customizer_Section_Notice(
					$manager, 'ta_info_travel_agency_companion', array(
						'section_text' => __( 'To have access to other sections please install and configure Travel Agency Companion plugin.', 'travel-agency-pro' ),
	...
	public function enqueue_control_scripts() {
        ...
        wp_enqueue_style( 'travel-agency-section-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/section-notice/css/section-notice.css', array(), TAP_THEME_VERSION );
		wp_enqueue_script( 'travel-agency-section-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/section-notice/js/section-notice.js', array( 'customize-controls' ), TAP_THEME_VERSION );
		wp_localize_script(
